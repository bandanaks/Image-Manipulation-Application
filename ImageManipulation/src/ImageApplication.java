...
public class ImageApplication extends Frame
{
    ...
    static ImageFrame frame_image_display = new ImageFrame();  //YOU MUST CREATE
    
    //Class to hold image data to be able to
    //manipulate
    static ImageData img_data;  //YOU MUST CREATE********
    
    Image img1;
    
    static Image ActiveI;
    // class variable created to hold icon image of application
    Image icon = Toolkit.getDefaultToolkit().getImage(".\\src\\colorwheel.jpg");
	...
	public ImageApplication()
	{
		...
		label_title.setText("Image Toolkit");
		label_title.setForeground(java.awt.Color.white);
		add(label_title);
		label_title.setFont(new Font("Dialog", Font.BOLD, 20));
		label_title.setBounds(84,36,245,51);
		label_title.setAlignment(java.awt.Label.CENTER);
		//$$ openFileDialog2.move(40,277);
		setTitle("Image Editing");
		setIconImage(icon);
		//}}
	...
	void openMenuItem_ActionPerformed_Interaction1(java.awt.event.ActionEvent event)
	{
		try {
		    ...
		    ImageData active = new ImageData(img, "java.awt.Image", img.getHeight(this), img.getWidth(this));
		    ActiveI = active.createImage();
		    
	        img_data = new ImageData(img, "java.awt.Image", img.getHeight(this), img.getWidth(this));
	       // img_data.brighten(100);
	        //img_data.threshold();
	        //img_data.negative();
	        Image img1 = img_data.createImage();
		    frame_image_display.setImage(img1);
		    frame_image_display.setVisible(true);
		    
		   
	
		    
		    //img_data.saveToFile(img1, Filename1);		 
		    //Create image_data object in which you  **** TO DO ***** YOU MUST DO ******
		    //store the data you wish to actually
		    //manipulate
		    //img_data = new ImageData(img1, "JPEG", height, width);
